...
struct IncrementLessonService: IncrementLessonProtocol {
    static func incrementLesson(userId: String) async throws -> (Data?, NetworkError?) {
        guard var urlComponents = URLComponents(string: ApiEndpoint.url + ApiEndpoint.incrementLesson.rawValue) else {
